...
def display_therapy_script_sections(pre_mudra=True):
    ...
    if pre_mudra:
        if lang == "Tamil":
            st.markdown("""
            <h2 style='color:#90EE90; text-align:center;'>🌿 முதியோர்களுக்கான நலம் மேம்பாட்டு நிகழ்வு 🌿</h2>
            ...
            <h4 style='color:#FFD700;'>🟢 1. விரல் பயிற்சி – 5 நிமிடம் (ஒவ்வொன்றும் 30 விநாடிகள்)</h4>
...
""", unsafe_allow_html=True)
            ...
            <p style='color:#FAFAD2;'>(சத்தமின்றி வாயை திறந்து கீழ் உள்ள எழுத்துக்களுக்கு ஏற்ப முக தசைகளை இயக்குதல்)</p>
            ...
            <h4 style='color:#FFD700;'>🟢 ஜீவராசிகள் சப்த பயிற்சி – 5 நிமிடம் </h4>
            <p style='color:#FAFAD2;'>(கீழ் உள்ள ஒவ்வொரு மிருக சத்தமும் 5 முறை ஒலி எழுப்ப வேண்டும் , 30 விநாடி)</p>
            """, unsafe_allow_html=True)
...
def main():
    ...
    if is_tamil:
        st.markdown("# 🌿 முதியோர் நலன் காக்கும் தொடுசிகிச்சை 🖐️")
