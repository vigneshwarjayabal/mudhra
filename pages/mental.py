...
def display_therapy_script_sections(pre_mudra=True):
    ...
    if pre_mudra:
        if lang == "Tamil":
            st.markdown("""
            <h2 style='color:#FFD700; text-align:center;'>🌿 மூத்தவர்கள் நலம் மேம்பாட்டு நிகழ்வு 🌿</h2>
...
""", unsafe_allow_html=True)
            ...
            <p style='color:#800000;'>(ஒவ்வொரு சத்தமும் 5 முறை, 30 விநாடி)</p>
            """, unsafe_allow_html=True)
...
""", unsafe_allow_html=True)
            ...
            <p style='color:#800000;'>🎯 சுவாசம், குரல் பயிற்சி, மன உறுதி</p>
            """, unsafe_allow_html=True)

        elif lang == "English":
            st.markdown("""
            <h2 style='color:#FFD700; text-align:center;'>🌿 Elder Wellness Program 🌿</h2>
            <p style='font-size:18px; color:#800000; text-align:center;'>
...
""", unsafe_allow_html=True)
            ...
            st.markdown("""
            <h2 style='color:#FFD700; text-align:center;'>🌿 वरिष्ठ नागरिक स्वास्थ्य कार्यक्रम 🌿</h2>
            <p style='font-size:18px; color:#800000; text-align:center;'>
...
""", unsafe_allow_html=True)
            ...
            <p style='color:#800000;'>(प्रत्येक ध्वनि 5 बार, 30 सेकंड)</p>
            """, unsafe_allow_html=True)
